...
acc=Table([
    ...
    [P('HARDWARE',S('ah',fontName='Helvetica-Bold',fontSize=7,textColor=EOC,leading=9)),
     P('Raspberry Pi 5 (16 GB)  ·  Pironman MAX 5  ·  2× 1 TB NVMe RAID 1  ·  ASUS RT-BE58 Go Wi-Fi 7  ·  UniFi Switch Flex 2.5G-5  ·  Windows laptop (Winlink Express + JS8Call + IC-7300)  ·  Operator stations: Raspberry Pi 500 + Pi Monitor 15.6\'',S('ad',fontSize=8,leading=11))],
